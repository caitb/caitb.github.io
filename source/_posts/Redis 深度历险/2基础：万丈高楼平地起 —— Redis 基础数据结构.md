---
title: 基础：万丈高楼平地起 —— Redis 基础数据结构
tags:
  - Redis
  - 转发
---

> <span style="color:rgb(61, 170, 214)">作者：</span>掘金小册
>
> <span style="color:rgb(61, 170, 214)">来源：</span>[https://mp.weixin.qq.com/s/JW__OgOBmCrOlh38ABCWNA](https://mp.weixin.qq.com/s/JW__OgOBmCrOlh38ABCWNA)



千里之行，始于足下。本节我们的学习目标是：快速理解并掌握 Redis 的基础知识。

由于本节内容是 Redis 最简单最容易掌握的知识，如果读者已经很熟悉 Redis 的基础数据结构，从珍惜生命的角度出发，你可以略过本节内容，跳到下一节继续阅读。如果你觉得本节的动画有点晃眼，阅读起来不那么舒服，可以看看作者的另一篇文章[《Redis 数据结构基础教程》](https://link.juejin.im/?target=https%3A%2F%2Fjuejin.im%2Fpost%2F5b53ee7e5188251aaa2d2e16)。
...
4. 如果读者懒于安装操作，也可以使用网页版的 [Web Redis](https://link.juejin.im/?target=https%3A%2F%2Ftry.redis.io%2F) 直接体验。
...
![img](https://user-gold-cdn.xitu.io/2018/7/24/164caaff402d2617?imageslim)
...
可以对 key 设置过期时间，到点自动删除，这个功能常用来控制缓存的失效时间。不过这个「自动删除」的机制是比较复杂的，如果你感兴趣，可以继续深入阅读第 26 节[《朝生暮死——过期策略》](https://link.juejin.im/?target=https%3A%2F%2Fjuejin.im%2Fbook%2F5afc2e5f6fb9a07a9b362527%2Fsection%2F5b4c42405188251b3950d251)
...
关于字符串的内部结构实现，请阅读第 32 节[《极度深寒 —— 探索「字符串」内部》](https://link.juejin.im/?target=https%3A%2F%2Fjuejin.im%2Fbook%2F5afc2e5f6fb9a07a9b362527%2Fsection%2F5b5af9d96fb9a04f83465ada)
...
![img](https://user-gold-cdn.xitu.io/2018/7/2/1645918c2cdf772e)
...
![](https://user-gold-cdn.xitu.io/2018/7/27/164d975cac9559c5?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
关于列表的内部结构实现，请阅读第 34 节[《极度深寒 —— 探索「压缩列表」内部》](https://link.juejin.im/?target=https%3A%2F%2Fjuejin.im%2Fbook%2F5afc2e5f6fb9a07a9b362527%2Fsection%2F5b5c95226fb9a04fa42fc3f6)和第 35 节[《极度深寒 —— 探索「快速列表」内部》](https://link.juejin.im/?target=https%3A%2F%2Fjuejin.im%2Fbook%2F5afc2e5f6fb9a07a9b362527%2Fsection%2F5b5c963be51d45199154e82e)
...
![](https://user-gold-cdn.xitu.io/2018/7/9/1647e419af9e3a87?imageView2/0/w/1280/h/960/format/webp/ignore-error/1)
...
![](https://user-gold-cdn.xitu.io/2018/7/2/16458ef82907e5e1?imageslim)
...
关于字典的内部结构实现，请阅读第 33 节[《极度深寒 —— 探索「字典」内部》](https://link.juejin.im/?target=https%3A%2F%2Fjuejin.im%2Fbook%2F5afc2e5f6fb9a07a9b362527%2Fsection%2F5b5bdbbd5188251ac22b5bf7)。
...
![](https://user-gold-cdn.xitu.io/2018/7/2/16458e2da04f1a2d?imageslim)
...
![](https://user-gold-cdn.xitu.io/2018/7/2/16458f9f679a8bb0?imageslim)
...
关于跳跃列表的内部结构实现，请阅读第 36 节[《极度深寒 —— 探索「跳跃列表」内部结构》](https://link.juejin.im/?target=https%3A%2F%2Fjuejin.im%2Fbook%2F5afc2e5f6fb9a07a9b362527%2Fsection%2F5b5ac63d5188256255299d9c)
